...
@WebServlet("/weeklyBoxOfficeList.do")
public class WeeklyBoxOfficeList extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			URL url = new URL("http://www.kobis.or.kr/kobisopenapi/webservice/rest/boxoffice/"
					+ "searchWeeklyBoxOfficeList.json?key="+kobisKey+"&targetDt="+date+"&weekGb=0");
